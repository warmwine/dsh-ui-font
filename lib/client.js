...
window.__ModuleLoader__.load({
    ...
    factory: (require) => {
        ...
        function FontSettingsPage() {
            ...
            return React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } },
                ...
                React.createElement("p", { style: { color: "rgba(128,128,128,.9)", margin: "4px 0 8px" } },
                    "不知道某块界面对应哪一项？点「选取区域」或按 Ctrl+Shift+F，用准星点它——就地加减字号。设置面板会挡住界面：建议关掉设置再按快捷键选取。"),
                React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", margin: "8px 0 4px", gap: 8 } },
                    ...
                    React.createElement("div", { style: { display: "flex", gap: 6 } },
                        React.createElement("button", {
                            ...
                            title: "点击后用准星在页面上点选任意区块；快捷键 Ctrl+Shift+F 随时开启（可先关闭设置面板再选取）"
                        }, "🎯 选取区域"),
        ...
        function apply(ctx) {
            ...
            // Global pick-mode hotkey (Ctrl+Shift+F): the settings panel is a
            // modal that covers the main UI, so picking from inside it can only
            // reach settings content. The hotkey works anywhere — including
            // with the panel closed — which is the whole point.
            const onHotkey = (e) => {
