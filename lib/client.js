...
window.__ModuleLoader__.load({
    ...
    factory: (require) => {
        ...
        function loadSettings() {
            try {
                ...
                return {
                    ...
                    delta: typeof s.delta === "number" && s.delta >= -3 && s.delta <= 8 ? Math.round(s.delta) : 3,
            ...
            return React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 4 } },
                ...
                row("全局字号偏移",
                    React.createElement(React.Fragment, null,
                        React.createElement("input", { type: "range", min: -3, max: 8, step: 1, value: s.delta,
        ...
        function apply(ctx) {
            ...
            // Startup: apply font styles exactly once (one synchronous scan).
            reapply();
            ctx.effect(() => () => {
